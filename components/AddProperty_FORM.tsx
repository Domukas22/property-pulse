...
export default function AddProperty_FORM() {
  ...
  const HANDLE_imageChange = (e: any) => {
    const { files } = e.target;

    const updates_IMAGES = [...fields.images];

    for (const file of files) {
      updates_IMAGES.push(file);
    }

    SET_fields({
      ...fields,
      images: updates_IMAGES,
    });
  };
